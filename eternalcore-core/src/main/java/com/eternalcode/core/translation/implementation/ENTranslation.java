...
public class ENTranslation extends AbstractTranslation {
    ...
    public static class ENAfkSection implements AfkSection {
        ...
        public Notice afkOn = Notice.chat("<gold>🛈 <gray>{PLAYER} <gray>is currently <dark_red>idle <gray>...");
        public Notice afkOff = Notice.chat("<gold>🛈 <gray>{PLAYER} <gray>has <green>reconnected <gray>with the <green>world<gray>!");
    ...
    public static class ENAutoMessageSection implements AutoMessageSection {
        ...
        public Map<String, Notice> messages = Map.of(
            ...
            "2", BukkitNotice.builder()
                .chat("<white>TIP <gray>You need help from an admin?")
                .chat("    <gray>Type command <white>/helpop <gray>to ask!")
                .chat("    <gray>You can just click here <green><click:suggest_command:'/helpop'>[CLICK HERE]</click></green>")
