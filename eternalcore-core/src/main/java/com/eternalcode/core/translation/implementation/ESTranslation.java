...
public class ESTranslation extends AbstractTranslation {
    ...
    public static class ENAfkSection implements AfkSection {
        ...
        public Notice afkOn = Notice.chat("<gold>🛈 <gray>{PLAYER} <gray>está actualmente <dark_red>inactivo <gray>...");
        public Notice afkOff = Notice.chat("<gold>🛈 <gray>{PLAYER} <gray>ha <green>reconectado <gray>con el mundo <green>!</gray>");
    ...
    public static class ENAutoMessageSection implements AutoMessageSection {
        ...
        public Map<String, Notice> messages = Map.of(
            ...
            "2", BukkitNotice.builder()
                .chat("<white>TIP <gray>Necesitas ayuda de un administrador?")
                .chat("    <gray>Escribe el comando <white>/helpop <gray>para pedirlo!")
                .chat("    <gray>Puedes simplemente hacer clic aquí <green><click:suggest_command:'/helpop'>[HAGA CLIC AQUÍ]</click></green>")
